...
$query_laporan=mysqli_query($conn,"SELECT * FROM tbl_histori WHERE status LIKE '%Barang Diterima%'");
...
$totalSQL  = mysqli_query($conn, "SELECT SUM(totalharga) as 'total' FROM tbl_histori WHERE status LIKE '%Barang Diterima%'") or die(mysqli_error($conn));

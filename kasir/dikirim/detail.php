...
// $result = $conn->query("SELECT * FROM tbl_pesanan INNER JOIN tbl_barang ON tbl_pesanan.id_barang where id_pesanan = '$id' ") or die($conn->error);  
...
<div class="info-box-content">
  ...
  <h4 class="info-box-number"><?php echo $row2['status'] . " - " .$row2['tgl_dikirim']; ?></h4>
</div>
<!-- /.info-box-content -->
</div>
...
<!-- /.info-box -->
          ...
          <form action="proses.php" method = 'post'>
            ...
            <button type = "submit" name = 'update_pengiriman' class = 'btn btn-primary mt-3 ml-2'> Barang Diterima</button>
            
            <div class="form-group mt-3 ml-2">
																<label>Alasan Dibatalkan :</label>
																<input id="nama" type="text" class="form-control" name="alasan">
															  </div>
											 

          <button type = "submit" name = 'cancel' class = 'btn btn-danger mt-3 ml-2'>Pesanan di Batalkan</button>
          </form>
